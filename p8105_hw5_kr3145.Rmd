...
The plot shows that as the group size increases, the probability that at least 2 people in the group will share a birthday will also increase. The increase starts to plateau slightly as it gets closer to group size of 50. At group size of 23, the probability that at least 2 people in the group will share a birthday is 50%.
...
Pull estimate and confidence interval of the proportion of homicides that are unsolved for Baltimore, MD only
...
Run prop.test to pull estimates and confidence intervals of the proportion of homicides that are unsolved for all cities
